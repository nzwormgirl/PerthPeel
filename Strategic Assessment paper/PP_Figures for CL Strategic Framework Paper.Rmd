...
dev.cum <- scenarios[[which(names(scenarios) %in% "scenario9_cumulative.development.lgz"==TRUE)]] # final version from the report
...
<<<<<<< HEAD
#png(paste0(output_path,"priority_conflict_insets_v2.png"),height=14,width=17.5,units="cm",res=300, bg="transparent",pointsize=10)
...
png(paste0(output_path,"priority_conflict_insets_v2_part1.png"),height=14,width=14,units="cm",res=300, bg="transparent",pointsize=10)
...
png(paste0(output_path,"priority_conflict_insets_v2_part2.png"),height=14,width=3.5,units="cm",res=300, bg="transparent",pointsize=10)
...
=======
sp.impacts <- read.csv(paste0(output_path,"CL_distribution.impacts_20140924_v2.csv"))
  sp.impacts[1:11] <- 1- sp.impacts[1:11]

development <- c("CL_current.development.lgz_20140924.CAZ_ME.curves.txt","CL_infrastructure_20140924.CAZ_ME.curves.txt","CL_brm.extraction_20140924.CAZ_ME.curves.txt","CL_pines_20140924.CAZ_ME.curves.txt","CL_cumulative.development.lgz_20140924.CAZ_ME.curves.txt","CL_eia1_20140924.CAZ_ME.curves.txt" ,"CL_eia2_20140924.CAZ_ME.curves.txt", "CL_eia3O1_20140924.CAZ_ME.curves.txt" ,"CL_eia3O2_20140924.CAZ_ME.curves.txt")
  dev.label <- c(paste0("1. Urban","\n","    Industrial"),"2. Infrastructure","3. Mining", "4. Forestry", paste0("5. Cumulative","\n","    development"),"EIA1","EIA2","EIA3O1","EIA3O2")
>>>>>>> 1a096226ecce0a502ce2cbb8f556ea0ab0c14d5a

png(paste0(output_path,"Figure3_v2.png"),height=62,width=82,units="mm",bg="transparent",pointsize=10,res=600)

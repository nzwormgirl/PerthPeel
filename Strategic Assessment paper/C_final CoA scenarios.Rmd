...
```{r proposed conservation reserves}
  ...
  PA.raster <- raster(paste0("protected.areas.tif"))
  ...
  CR.PA.high.raster <- merge(CR.phase1.raster,CR.phase2.raster,PA.raster.high,filename="high_protected_areas_conservation_reserves", format="GTiff", overwrite=T)

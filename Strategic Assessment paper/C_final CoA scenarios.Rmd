...
start.time <- proc.time()
  ...
  computer <- "J:/UM backup/"

  envi.directory <- paste0(computer, "GIS_data/Perth-Peel/")
  output.directory <- paste0(computer, "GIS_data/Perth-Peel/zonation/100m/scenarios/final/Conservation Letters/")
...
perth <- raster(paste0(computer,"GIS_data/Perth-Peel/environmental data/100m/region.mask.asc"))
  perth[!is.na(perth)] <- 2
clipping.mask <- raster(paste0(computer, "GIS_data/Perth-Peel/environmental data/100m/clipping.mask.tif"))

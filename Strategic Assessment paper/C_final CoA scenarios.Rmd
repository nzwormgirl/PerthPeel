...
```{r merge eia scenarios with existing urban}
  ...
  dop.EIA3_Option1_30102013.existing.raster <- merge(dop.existing.urban.raster,dop.EIA3_Option1_30102013.raster,filename="scenario1_3a_eia3_2ption1_existing", format="GTiff", overwrite=T)
  
  dop.EIA3_Option2_30102013.existing.raster <- merge(dop.existing.urban.raster,dop.eia1.raster,filename="scenario1_3b_eia3_option2_existing", format="GTiff", overwrite=T)

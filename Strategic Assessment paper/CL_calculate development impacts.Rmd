...
# match scenario with mask layer
  ...
  loss.table$scenario <- c("EIA1","EIA2","EIA3O1","EIA3O2","EIA4","1.1 EIA1","1.1 EIA1 existing","1.2 EIA2","1.2 EIA2 existing", "1.3a EIA3 Option1", "1.3a EIA3 Option1 existing", "1.3b EIA3 Option2", "1.3b EIA3 Option2 existing", "1.4 Development Footprint", "1.4 Development Footprint existing", "1. Urban","2. Industrial","3. Rural Residential", "4. Infrastructure", "5. Forestry", "6. Mining", "7. Cumulative")
  loss.table$order <- c(18,19,20,21,22,8,13,9,14,10,15,11,16,12,17,1,2,3,4,5,6,7)
...
# create table for species of interest
  ...
  Fig4_table <- special.sp.table[,c("scenario","cleared","mean.loss","Caladenia_huegelii","Drakaea_elastica","Calyptorhynchus_latirostris","Pseudocheirus_occidentalis","Conospermum_undulatum")]
    Fig4_table <- Fig4_table[Fig4_table$scenario %in% c("1.1 EIA1 existing","1.2 EIA2 existing","1. Urban","EIA1","EIA2","EIA3O1","EIA3O2","EIA4"),]

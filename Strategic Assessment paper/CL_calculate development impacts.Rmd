...
PP.shp <- readShapePoly("~/GIS_data/Perth-Peel/mask files/DoP_StrategicAssessmentStudyBoundary_Extended_20121004_GDA94.shp", proj4=GDA94)
  PP.shp <- spTransform(PP.shp,GDA94.50)

IBRA.shp <- readShapePoly("~/GIS_data/Perth-Peel/mask files/PP_IBRA.shp", proj4=GDA94.50)
=======
...
<<<<<<< HEAD
development <- c("scenario3_development.footprint.lgz","scenario8_infrastructure","scenario6_brm.extraction","scenario7_pines","scenario9_cumulative.development.lgz","CL_EIA1","CL_EIA2","CL_EIA3O1","CL_EIA3O2")
...
<<<<<<< HEAD
write.csv(conflict.table,paste0(output_path,"CL_conflict.table_",analysis.date,"_v2.csv"),row.names=F)
=======
...
#     loss.table$mask.layer <- gsub(paste0("_",analysis.date),"",gsub("CL_","",loss.table[,1]))
    loss.table$mask.layer <- c("scenario6_brm.extraction",
                               "scenario9_cumulative.development.lgz",
                               "scenario9_cumulative.development",
                               "scenario3_development.footprint.lgz",
                               "scenario3_development.footprint",
                               "CL_EIA1",
                               "CL_EIA2",
                               "CL_EIA3O1",
                               "CL_EIA3O2",
                               "scenario8_infrastructure",
                               "scenario7_pines",
                               "protected.areas")
    loss.table$order <- c(4,7,6,2,1,9,10,11,12,3,5,8)
=======
  # loss.table[,1] <- gsub('.curves.txt', '', loss.files)
...
<<<<<<< HEAD
 write.csv(distribution.table, paste0(output_path, '/CL_distribution.impacts_',analysis.date,'_v2.csv'), row.names=F)
=======
...
<<<<<<< HEAD
 write.csv(loss.table, paste0(output_path, '/CL_Development plan impacts_',analysis.date,'_v2.csv'), row.names=F)
=======

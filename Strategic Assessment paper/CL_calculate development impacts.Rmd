...
# create table for species of interest
  special.sp.table <- d(scenario=loss.table$scenario, cleared=loss.table$area.cleared, mean.loss=loss.table$`mean.loss(%)`, Calyptorhynchus_latirostris=NA, cbc.feeding=NA, Drakaea_elastica=NA, Caladenia_huegelii=NA, Conospermum_undulatum=NA, Pseudocheirus_occidentalis=NA, "Limestone_ridges_(SCP_26a)"=NA, EPA_Biodiversity3_10pct=NA, EPA_Biodiversity3_30pct=NA, mask.layer=loss.table$mask.layer, fraction=NA)

  colnames(special.sp.table) <- c("scenario","cleared","mean.loss","Calyptorhynchus_latirostris","cbc.feeding","Drakaea_elastica","Caladenia_huegelii","Conospermum_undulatum","Pseudocheirus_occidentalis","Limestone_ridges_(SCP_26a)","EPA_Biodiversity3_10pct","EPA_Biodiversity3_30pct","mask.layer","fraction")
  ...
  Fig4_table <- special.sp.table[,c("scenario","cleared","mean.loss","Caladenia_huegelii","Drakaea_elastica","Calyptorhynchus_latirostris","Pseudocheirus_occidentalis","Conospermum_undulatum")]
    Fig4_table <- Fig4_table[Fig4_table$scenario %in% c("1.1 EIA1 existing","1.2 EIA2 existing","1. Urban"),]
    
  write.csv(Fig4_table,paste0(output_path,"tables/Figure_special.sp.table_",analysis.date,".csv"),row.names=F)

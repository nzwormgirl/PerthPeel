...
existing.development <- readShapePoly("~/GIS_data/Perth-Peel/DOP/DoP_Development_Footprint_20140310.shp")
  exist.dev.raster <- shp2raster(existing.development[grepl("Developed",existing.development$DEVELOPED),], perth,value=0,bkg=1, label="DoP_Development_Footprint_20140310_developed", transform=F )
...
```{r merge layers}
rasters <- list(nvis_mvs_exotics,epa.bio3,world.heritage,national.heritage,commonwealth.heritage,ramsar,epa.bio2,rem.veg,tec,cec,saltmarsh,mig.birds.raster, exist.infra.raster, exist.dev.raster)
